...
func (t Training) meanSpeed() float64 {
	...
	if float64(t.Duration.Hours()) == 0 {
		panic("Zero Division is not excepted!")
	}
...
func (r Running) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	info := InfoMessage{}
	info.TrainingType = r.Training.TrainingType
	info.Duration = r.Training.Duration
...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	return ((CaloriesWeightMultiplier*w.Training.Weight + (math.Pow(w.Training.meanSpeed(), 2)/w.Height)*CaloriesSpeedHeightMultiplier*w.Training.Weight) * float64(w.Training.Duration.Hours()) * MinInHours)
}
...
func (w Walking) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	info := InfoMessage{}
	info.TrainingType = w.Training.TrainingType
	info.Duration = w.Training.Duration
...
func (s Swimming) meanSpeed() float64 {
	// вставьте ваш код ниже
	if float64(s.Training.Duration.Hours()) == 0 {
		panic("Zero Division is not excepted!")
	}
...
func (s Swimming) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	info := InfoMessage{}
	info.TrainingType = s.Training.TrainingType
	info.Duration = s.Training.Duration
